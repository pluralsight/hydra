...
import hydra.common.alerting.NotificationRequestBaker
...
trait NotificationsTestSuite extends MockFactory {
  ...
  def getNotificationSenderMock[F[_] : Monad]: NotificationSender[F] = {
    ...
    (notificationSenderStub.send(_: NotificationScope, _: NotificationMessage[String])(_: Any)(_: JsonFormat[String], _: NotificationRequestBaker[F, Any]))
      .when(*, *, *, *, *)
