...
class CreateTopicProgramSpec extends AsyncFreeSpec with Matchers with IOSuite {
  ...
  "CreateTopicSpec" - {
    ...
    "throw error on key schema evolution with missing required fields createdAt" in {
      ...
      result.attempt.map(_ shouldBe RequiredSchemaKeyFieldMissingError("createdAt", keySchema, "Entity").asLeft)
    }
    ...
    "throw error on value schema evolution with missing required fields doc" in {
      ...
      result.attempt.map(_ shouldBe RequiredSchemaValueFieldMissingError("doc", valueSchema, "Entity").asLeft)
    }
    ...
    "throw error on value schema evolution with missing required fields updatedAt" in {
      ...
      result.attempt.map(_ shouldBe RequiredSchemaValueFieldMissingError("updatedAt", valueSchema, "Entity").asLeft)
    }
