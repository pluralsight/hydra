...
sealed trait TopicMetadataV2Parser
  ...
  implicit val newMetadataValidationFormat: EnumEntryJsonFormat[MetadataValidationType] =
    new EnumEntryJsonFormat[MetadataValidationType](MetadataValidationType.values)
